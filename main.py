...
testbmp.Erase(hwreset=False)
print("Flashing target application")
testbmp.Flash("./binfiles/application.bin", verify=True, hwreset=False)
print("Flashing target UICR")
testbmp.Flash("./binfiles/uicr.bin", verify=True, hwreset=False, start=0x10001000, len=1024)
